...
int main(int argc, char* argv[]){
  ...
  ankh::read_tinker_file_quad("../systems/ubiquitin2.xyz","../systems/ankh_ubiquitin2.txt",N,parts,q,rad);
  ...
  //std::cout<<"res = "<<res<<" cste "<<cste<<std::endl;
